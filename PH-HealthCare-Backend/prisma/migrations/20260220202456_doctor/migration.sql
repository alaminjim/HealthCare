...
-- AddForeignKey
ALTER TABLE "DoctorSpecialty" ADD CONSTRAINT "DoctorSpecialty_specialId_fkey" FOREIGN KEY ("specialId") REFERENCES "specialties"("id") ON DELETE CASCADE ON UPDATE CASCADE;
